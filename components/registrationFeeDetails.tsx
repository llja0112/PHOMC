      ...
      <table className="table table-striped-columns table-hover table-responsive mb-3">
        <thead>
          <tr>
            ...
            <th scope="col">Early Bird Rate<br /><small className="text-muted">(Ends 30 June 2024)</small></th>
            <th scope="col">Regular Rate<br /><small className="text-muted">(Starts 1 July 2024)</small></th>
          </tr>
        </thead>
        <tbody>
          <tr>
